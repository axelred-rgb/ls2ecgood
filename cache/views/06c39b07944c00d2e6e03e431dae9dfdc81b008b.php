			...
			<div class="row">
				<div class="col-12">
					<div class="text-center">						
						<h2 class="page-title text-white"><?php echo tt("Resources"); ?></h2>
					...
					<div class="box">
						...
						<div class="row g-0">
							...
							<div class="col-md-8 col-12">
								<div class="box-body">
									<h4><a href="<?php echo e(route('blog')); ?>/<?php echo e($articles->getId()); ?>"><?php echo e($articles->getTitle()); ?></a></h4>
									...
									<div class="flexbox align-items-center mt-3">
										<a class="btn btn-sm btn-primary" href="<?php echo e(route('blog')); ?>/<?php echo e($articles->getId()); ?>"><?php echo tt("Read more"); ?></a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yvafrkyk/public_html/web/views/bloglist.blade.php ENDPATH**/ ?>