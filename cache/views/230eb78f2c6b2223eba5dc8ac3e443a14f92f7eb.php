...
<?php $__env->startSection('content'); ?>
	<!---page Title --->
	<section class="bg-img pt-150 pb-100" data-overlay="7" style="background-image: url(<?php echo e(assets); ?>images/front-end-img/background/bg-8.jpg);">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="text-center">
						<br>
						<br>
						<h2 class="page-title text-white" style="font-size: 5rem; text-transform: lowercase"><?php echo tt("Le chemin de l'excellence"); ?></h2>
			...
			<div class="row justify-content-center">
				<div class="col-12">
					<div class="text-center no-border">
						<h1 class="box-title" ><?php echo tt("Augmentez votre valeur"); ?></h1>
					</div>
				</div>
				<div class="col-xl-6 col-6" style="text-align: center;">
					<div class="box box-body">
						<div class="box-body" >
							<img src="<?php echo e(assets); ?>images/avatar/stage.png" alt="..." >
							<br>
							<h1 class="mb-15"><?php echo tt("Compétence"); ?></h1>
							<br>
							<p class="fs-22" style="text-align: justify"><?php echo tt("desc1_avantage1","Nous vous garantissons la compétence, car nos  formateurs utilisent une pédagogie créative basée des illustrations par l’image et par des exemples concrets et pratiques sur les problèmes rencontrés en entreprise."); ?></p>
				...
				<div class="col-xl-6 col-6">
					<div class="box box-body" style="text-align: center;">
						<div class="box-body">
							<img src="<?php echo e(assets); ?>images/avatar/confidence.png" alt="..." style="width: 128px; height: 128px;">
							<br>
							<h1 class="mb-15"><?php echo tt("Confiance"); ?></h1>
							<p class="fs-20" style="text-align: justify"><?php echo tt("Votre niveau de confiance grandira parce que vous serez compétent(e)s."); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-6 col-6">
					<div class="box box-body" style="text-align: center;">
						<div class="box-body">
							<img src="<?php echo e(assets); ?>images/avatar/promotion.png" alt="..." >
							<br>
							<h1 class="mb-15"><?php echo tt("Succès à vos entretiens d’embauche"); ?></h1>
							<p class="fs-20" style="text-align: justify"><?php echo tt("Vos entretiens d’embauche seront une formalité parce que vous serez compétent(e)s et confiant(e)s."); ?></p>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-7 col-12 text-center">
					<h1 class="mb-15"><?php echo tt("Nos formateurs sont certifiés"); ?></h1>
					...
					<div class="owl-stage-outer">
						<div class="owl-stage" >
							<div class="owl-item cloned" >
								<div class="item">
									<img src="<?php echo e(assets); ?>images/avatar/ccna.png" style="width: 199.833px; height: 133px;" class="img-fluid my-15 rounded box-shadowed pull-up" alt="">
								</div>
							</div>
				...
				<div class="col-2">
					<div class="owl-stage-outer">
						<div class="owl-stage" >
							<div class="owl-item cloned" >
								<div class="item">
									<img src="<?php echo e(assets); ?>images/avatar/ccnp1.png" style="width: 199.833px; height: 133px;" class="img-fluid my-15 rounded box-shadowed pull-up" alt="">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-2">
					<div class="owl-stage-outer">
						<div class="owl-stage" >
							<div class="owl-item cloned" >
								<div class="item">
									<img src="<?php echo e(assets); ?>images/avatar/ccie.png" style="width: 199.833px; height: 133px;" class="img-fluid my-15 rounded box-shadowed pull-up" alt="">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-2">
					<div class="owl-stage-outer">
						<div class="owl-stage" >
							<div class="owl-item cloned" >
								<div class="item">
									<img src="<?php echo e(assets); ?>images/avatar/nse4.png" style="width: 150px; height: 133px;" class="img-fluid my-15 rounded box-shadowed pull-up" alt="">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-2">
					<div class="owl-stage-outer">
						<div class="owl-stage" >
							<div class="owl-item cloned" >
								<div class="item">
									<img src="<?php echo e(assets); ?>images/avatar/nse7.png" style="width: 150px; height: 133px;" class="img-fluid my-15 rounded box-shadowed pull-up" alt="">
								</div>
							</div>
						</div>
					</div>
												...
												<div class="price-table bg-gray-100">
													...
													<div class="price-top bg-white">
														<div class="price-title">
															...
															<span><?php echo tt('Available from January 2022'); ?></span>
														</div>
														<div class="price-prize">
															...
															?>
																<label style="font-size: 18px; font-weight: bold" for=""><?php echo tt('Europe-Amerique-Asie'); ?></label>
																<h2 style="font-size: 1.3rem"><?php echo e($pricem); ?> € /<span> <?php echo tt("month"); ?></span> <span><?php echo tt("or"); ?></span> <?php echo e($price); ?> € / <span><?php echo tt("year"); ?></span></h2>
																<hr>
																<label style="font-size: 18px; font-weight: bold" for=""><?php echo tt('Afrique'); ?></label>

																<h2 style="font-size: 1.3rem"><?php echo e($priceafricam); ?> € /<span> <?php echo tt("month"); ?></span> <span><?php echo tt("or"); ?></span> <?php echo e($priceafrica); ?> € / <span><?php echo tt("year"); ?></span></h2>
														</div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yvafrkyk/public_html/web/views/individual.blade.php ENDPATH**/ ?>