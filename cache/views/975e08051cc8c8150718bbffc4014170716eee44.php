...
<!-- Event snippet for Ajout au panier * Le client a cliqué sur une offre conversion page -->
    ...
    <?php
        ...
        $_Country_Name =  $ipdat->geoplugin_countryName ;
        $_City_Name =  $ipdat->geoplugin_city ;
        $_Continent_Name =  $ipdat->geoplugin_continentName ;
        $_Latitude =  $ipdat->geoplugin_latitude ;
        $_Longitude =  $ipdat->geoplugin_longitude ;
        $_Currency_Symbol =  $ipdat->geoplugin_currencySymbol ;
        $_Currency_Code =  $ipdat->geoplugin_currencyCode ;
        $_Timezone =  $ipdat->geoplugin_timezone;
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead>
                                    <tr>
                                        <th><?php echo tt("Target"); ?></th>
                                        <th><?php echo tt("Plan"); ?></th>
                                        <th><?php echo tt("Unit price"); ?></th>
                                        <th hidden><?php echo tt("Period"); ?></th>
                                        <?php if($subscription->getTarget() == 'pecb'): ?>
                                            <th><?php echo tt("Détails"); ?></th>
                                        <?php endif; ?>
                                    ...
                                    <tbody>
                                    <tr>
                                        <?php if($subscription->getTarget()=="i"): ?>
                                            <td><?php echo tt("Individuals"); ?></td>
                                        <?php elseif($subscription->getTarget()=="pecb"): ?>
                                            <td><?php echo tt("PECB"); ?></td>
                                        <?php else: ?>
                                            <td><?php echo tt("Enterprise"); ?></td>
                                        <?php endif; ?>
                                        <td><?php echo e($subscription->getName()); ?></td>
                                        <td>
                                            <?php if(App::$user->getId()): ?>
                                                <span id="initprice">
                                                    <?php echo e($subscription->getM_price('check')); ?>

                                                </span>
                                                €
                                                <?php if($subscription->getMonth() > 0): ?>
                                                    - <?php echo e($subscription->getMonth()); ?> <?php echo tt("Month"); ?>
                                                <?php endif; ?>
                                            <?php else: ?>
                                        ...
                                        <?php if($subscription->getTarget()=="i"): ?>
                                            ...
                                            <td hidden>
                                                <?php $a = '12'.tt("mounths")?>
                                                <label for=""><?php echo tt("Nombre de mois"); ?></label>
                                                <input type="number" min="1" id="qte" value="<?php echo e($subscription->getMonth()); ?>" style="border-color:#0b8e36" class="form-control">
                                            </td>
                                        <?php else: ?>
                                            <td>
                                                <?php $a = '5'.tt("days")?>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <?php if(!App::$user->getId()): ?>
                                                    <button onclick="location.href='<?php echo e(route('login')); ?>';" type="button" class="btn btn-info w-p100 mt-15"><?php echo tt("Login to apply promo code"); ?></button>
                                                <?php else: ?>
                                                    <button onclick="checkCode(this)" class="btn btn-primary mt-2"><?php echo tt('Appliquer le code promo'); ?></button>
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <tr id="pricetotal_tr">
                                        <th colspan="<?php echo e($colspan); ?>" class="text-end"><?php echo tt("Total HT"); ?></th>
                                        <th id="pricetotal">
                                            0 €
                                        </th>
                                    </tr>
                                    <tr id="pricetva_tr">
                                        <th colspan="<?php echo e($colspan); ?>" class="text-end"><?php echo tt("TVA"); ?> (20%)</th>
                                        <th id="pricetva">
                                            0 €
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="<?php echo e($colspan); ?>" class="text-end"><?php echo tt("Total TTC"); ?></th>
                                        <th id="pricetotalttc">
                                            0 €
                                        </th>
                                    </tr>
                                ...
                                <hr>
                                    ...
                                    <h4 class="box-title mb-15">
                                        ...
                                        <label class="box-title mb-15" for="cgu" style="font-size: 1.2857142857142858rem">
                                            <?php echo tt("J'accepte les"); ?> <a target="_blank" href="<?php echo e(__front); ?>document/CGV.pdf"><?php echo tt("conditions générales de ventes"); ?></a>
                                        </label><br>
                                    </h4><br>
                                                ...
                                                <div class="p-30">
                                                    <div id="smart-button-container">
                                                        ...
                                                        <div style="text-align: center;">
                                                            ...
                                                            <?php if(is_null($subscription->getPaypalplan())): ?>
                                            ...
                                            <div class="col-lg-5 col-md-5 col-12">
                                                <div class="box box-body">
                                                    ...
                                                    <div class="content-top-agile pb-0 pt-20">
                                                        <h2 class="text-primary"><?php echo tt("Vous avez déja souscrit à cet abonnement ! "); ?></h2>

                                                    </div>
                                                    <div class="p-40">
                                                        <?php $_SESSION['IDSUBSCRIPTION'] = ""; ?>
                                                        <a href="<?php echo e(route('myboard')); ?>" type="button" class="btn btn-info w-p100 mt-15"><?php echo tt("Continuer"); ?></a>
...
<?php $__env->startSection("jsimport"); ?>
    ...
    <script>
        ...
        var subscription = '<?php echo e($subscription->getId()); ?>';
        var route = '<?php echo e(route('confirmorder')); ?>?id='+subscription;
        var initprice = parseFloat('<?php echo e($subscription->getM_price('check')); ?>');
        var inityear = parseFloat('<?php echo e($subscription->getY_price('check')); ?>');
        var initpricemonth = parseFloat('<?php echo e($subscription->getM_price('check')); ?>');
        var tva = (20*initprice)/100;
        var ttc = initprice + tva;
        var route = '<?php echo e(route('confirmorder')); ?>?id='+subscription;
        let nbre_month  = <?php echo e($subscription->getMonth()); ?>;


        route = '<?php echo e(route('confirmordernew')); ?>?id='+subscription;
        route += '&month='+<?php echo e($subscription->getMonth()); ?>;

        setAllprice(<?php echo e($subscription->getM_price()); ?>, 0, '<?php echo e($subscription->getPaypalplan()); ?>');
                ...
                if(data.listEntity.length > 0){
                    ...
                    if(data.listEntity[0].nbremonth == 0 || data.listEntity[0].state != 0){
                        ...
                        if(data.listEntity[0].nbremonth !== -1){
                            ...
                            if(data.listEntity[0].code != code){
                                ...
                                if(data.listEntity[0].nbremonth <= nbre_month){
                                    ...
                                    <?php if(!is_null($subscription->getPaypalplan())): ?>
                                        ...
                                        $.get(__env+"api/lazyloading.codepromosubscription?dfilters=on&codepromo_id:eq="+data.listEntity[0].id+"&subscription_id:eq=<?php echo e($subscription->getId()); ?>", function(data, status){
                                            console.log(data);
                                                ...
                                                var settings = {
                                                    ...
                                                    "data": JSON.stringify({
                                                        "codepromosubscription": {
                                                            "id": "",
                                                            "codepromo.id": codeid,
                                                            "subscription.id": <?php echo e($subscription->getId()); ?>,
                                                        }
                                                    }),
                                                };
                                            ...
                                            //alert(paypalplan);
                                            price = setAllprice(price, parseFloat(valeur) / 100,paypalplan);
                                            $('#errorcode').html('<span style="color:#0b8e36">' + valeur + ' % <?php echo tt("de réduction"); ?></span>');


                                        });
                                    <?php else: ?>
                                        price = setAllprice(price, parseFloat(valeur) / 100);
                                        $('#errorcode').html('<span style="color:#0b8e36">' + valeur + ' % <?php echo tt("de réduction"); ?></span>');
                                    <?php endif; ?>
                            ...
                            price = setAllprice(price, parseFloat(data.listEntity[0].valeur) / 100);
        ...
        function setAllprice(price, reduction = 0, paypalplan){
            ...
            <?php if($_Country_Name !== 'France'): ?>
                $('#pricetva_tr').attr('hidden',true);
                $('#pricetotal_tr').attr('hidden',true);
                $('#initprice').html(ttc);
                $('#price span').html(ttc);
            <?php endif; ?>
            ...
            // //alert(id);
            //     //alert(text);
                let route2 = '<?php echo e(route('cinetpayconfirmorder')); ?>?'+text;
                //alert(route2);
                let devise = 'XAF';
                let description = '<?php echo e($subscription->getName()); ?>';
                ...
                purchase(price, 'Euro', 'EUR', "<?php echo e($subscription->getName()); ?>" , '<?php echo e($a); ?>', '#paypal-button-container',function(){ location.href = route; });
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yvafrkyk/public_html/web/views/cart.blade.php ENDPATH**/ ?>