					...
					<tr>
						...
						<td>
							<?php if($u_courses->statut != 0): ?>
								<a target="_blank" href="<?php echo e('gotocourse'); ?>?id=<?php echo $u_courses->getProvidercoursesid(); ?>"><span  class="badge badge-success badge-lg"><?php echo tt("continue"); ?></span>
								</a>
							<?php endif; ?>
						<td>
					</tr>
...
<?php echo $__env->make('board.layoutboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yvafrkyk/public_html/web/views/board/myboard.blade.php ENDPATH**/ ?>