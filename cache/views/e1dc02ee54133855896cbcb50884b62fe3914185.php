		...
		<div class="container h-p100">
		  <div class="row h-p100 align-items-center justify-content-center text-center">
			  <div class="col-lg-7 col-md-10 col-12">
				  <div>
					  <img src="<?php echo e(assets); ?>images/404.png" class="max-w-650 w-p100" alt="" />
					  <h1><?php echo tt("Page Non trouvée !"); ?></h1>
					  <h3><?php echo tt("Il semble que cette ressource soit indisponible"); ?></h3>
					  <div class="my-30" >
						  <a href="<?php echo isset($_SESSION['ls2ec_last_url']) ? $_SESSION['ls2ec_last_url'] : route('home'); ?>" class="btn btn-primary">
							  <?php echo tt("Retournez à la page précédente"); ?>
						  </a>
					  </div>
...
<?php /**PATH /home/yvafrkyk/public_html/web/views/error.blade.php ENDPATH**/ ?>