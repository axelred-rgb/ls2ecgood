			...
			<div class="row">
				<div class="col-12">
					<div class="text-center">
						<h2 class="page-title text-white"><?php echo tt("About us"); ?></h2>
					...
					<div class="row">
						<div class="col-12">
							<div style="border: 1px solid #f4f9fe;margin-top: 10px;border-radius: 20px;padding:20px!important;background: #f4f9fe;text-align: center">
								...
								<strong class="mbr-section-subtitle align-center mbr-fonts-style mb-0 display-2 stat">
									<?php echo tt("+ 10 000 personnes formées dans 12 pays"); ?>
								</strong>
							</div>
							<div style="border: 1px solid #f4f9fe;margin-top: 10px;border-radius: 20px;padding:20px!important;background: #f4f9fe;text-align: center">
								<strong class="mbr-section-subtitle align-center mbr-fonts-style mb-0 display-2 stat">
							...
							<div style="border: 1px solid #f4f9fe;margin-top: 10px;border-radius: 20px;padding:20px!important;background: #f4f9fe;text-align: center">
								...
								<strong class="mbr-section-subtitle align-center mbr-fonts-style mb-0 display-2 stat">
									<?php echo tt("98% Taux de satisfaction"); ?>
								</strong>
							</div>
						</div>
					</div>
				...
				<div class="counter-container col-12 col-md-12 col-lg-7">
					<div class="card">
						<div class="wrapper wrapls">
							...
							<h2 class="mbr-section-title align-left mbr-fonts-style mb-3 display-5"><strong><?php echo tt("C'est quoi LS2EC TRAINING ?"); ?></strong></h2>

							<div class="mbr-list mbr-fonts-style display-7">
								<p class="fs-16" style="text-align: justify!important;">
									<br>
									<?php echo tt("C'est la réponse contre le syndrome de l'imposteur vécu par les étudiants/élèves ingénieurs en fin d'études auprès de certaines ESN."); ?>
									<br>
									<br>	<?php echo tt("C'est aussi la réponse pour aider des personnes en reconversion professionnelle afin qu'elles puissent apprendre la cybersécurité grâce à une approche en douceur."); ?>
									<br>
									<br>	<?php echo tt("C'est une approche en douceur en 3 étapes claires :"); ?>
									<br>
									<br>	<b>- <?php echo tt("Étape 1 : Notion de base et avancée en réseau informatique"); ?></b>
									<br>	<?php echo tt("Ici on vous apprend ce qu'est un réseau, ce qu'est internet, car aujourd'hui les cyberattaques exploitent internet et les réseaux d'entreprise."); ?>
									<br>
									<br>	<b>- <?php echo tt("Étape 2: Notion de base et avancée en sécurité informatique."); ?></b>
									<br>	<?php echo tt("Ici on vous apprend tout ce qui constitue les infrastructures de sécurité, et comment mettre en place des règles et politiques de sécurité."); ?>
									<br>
									<br>	<b>- <?php echo tt("Étape 3: La cybersécurité"); ?></b>
									<br>	<?php echo tt("Ici on vous embarque dans l'univers des cyberattaquants , on vous apprend comment ils pensent et surtout comment les contrer."); ?>
									<br>
									<br>	<?php echo tt("C'est une culture d'entreprise reposant sur 3 valeurs fortes: "); ?>
									<br>
									<br>	- <b><?php echo tt("Passion :"); ?></b> <?php echo tt(" Être passionné de technologie dans le domaine informatique."); ?>
									<br>
									<br>	- <b><?php echo tt("Pédagogie :"); ?></b> <?php echo tt(" Savoir vulgariser les savoirs techniques complexes en fonction du niveau des clients et Savoir être."); ?>
									<br>
									<br>	- <b><?php echo tt("Créativité :"); ?></b> <?php echo tt(" Être sans cesse en capacité d'innover dans la manière de transmettre le savoir-faire."); ?>

									<br>
									<br>
								</p>
							</div>
							<p class="mbr-text align-left mbr-fonts-style mb-4 display-7"><?php echo tt("Alors, il n’y a pas de hasard : vous êtes exactement au bon endroit pour trouver une solution adaptée !"); ?> </p>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="title col-md-12 col-lg-7 d-flex align-items-center justify-content-center">
					<h4 class="mbr-section-subtitle align-center mbr-fonts-style mb-0 display-2"><strong><?php echo tt("Qui suis-je pour vous parler de carrière et de cybersécurité ?"); ?></strong></h4>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="сol-12 col-md-3 col-lg-2">
					<div class="people-wrapper">
						...
						<div class="people-title">
							...
							<p class="people-desc mbr-fonts-style display-4"><?php echo tt("Founder, LS2EC TRAINING"); ?></p>
						</div>
					</div>
				</div>
			...
			<div class="row justify-content-center">
				<div class="col-12 title-col pb-5" style="padding-bottom: 3rem!important">
					<h2 class="main-title align-center mbr-black m-0 mbr-fonts-style display-2">
						<strong><?php echo tt("Les avantages de notre système de formation"); ?></strong>
						<br>
					</h2>
				</div>
				<div class="col-12 col-md-6 col-lg-3">
					<div class="card-wrapper">
						<div class="card-box align-left">
							...
							<p class="card-text mbr-fonts-style display-7"><?php echo tt("Vous êtes préparé aux certifications les plus importantes : CCNA 200-301, CCNP 350-401 ENCOR, Fortinet NSE4, Fortinet NSE7."); ?><br></p>
						</div>
					</div>
				</div>
				<div class="col-12 col-md-6 col-lg-3">
					<div class="card-wrapper">
						<div class="card-box align-left">
							...
							<p class="card-text mbr-fonts-style display-7"><?php echo tt("Vous avez un environnement de travail pratique qui coûte généralement plus de 1000€ à construire car il faut obtenir diverses licences payantes."); ?><br></p>
						</div>
					</div>
				</div>
				<div class="col-12 col-md-6 col-lg-3">
					<div class="card-wrapper">
						<div class="card-box align-left">
							...
							<p class="card-text mbr-fonts-style display-7"><?php echo tt("Vous n’êtes pas tout seul devant votre écran :"); ?><br><strong>*</strong>&nbsp;<?php echo tt("Vous pouvez poser des questions et obtenir des réponses rapidement."); ?><br><strong>*</strong><?php echo tt(" Vous êtes suivi de près tout au long de votre formation pour assurer votre réussite."); ?><br></p>
						</div>
					</div>
				</div>
			...
			<div class="row align-center justify-content-center">
				<div class="col-12 col-md-12">
					<h3 class="main-title align-center pb-5 mbr-semibold mbr-white mbr-fonts-style display-2" style="padding-bottom: 3rem!important">
						<?php echo tt("Notre méthode fonctionnera pour vous si :"); ?></h3>
				</div>
				<div class="card md-pb col-12 col-md-6 col-lg-4">
					<div class="card-wrapper">
						<span class="mbr-iconfont mobi-mbri-idea mobi-mbri"></span>
						<div class="card-box">
							<h5 class="card-title mbr-semibold pb-2 mbr-white mbr-fonts-style display-7"><?php echo tt("Si vous êtes passionné(e) d'informatique."); ?></h5>
					...
					<div class="card-wrapper">
						...
						<div class="card-box">
							<h5 class="card-title mbr-semibold pb-2 mbr-white mbr-fonts-style display-7">
								<?php echo tt("Vous êtes prêt à consacrer 1h par jour à votre formation pour avoir le statut d’expert dans 6 mois au moins."); ?></h5>
				...
				<div class="card col-12 col-md-6 col-lg-4">
					<div class="card-wrapper">
						...
						<div class="card-box">
							<h5 class="card-title mbr-semibold pb-2 mbr-white mbr-fonts-style display-7">
								<?php echo tt("Vous êtes ambitieux et savez qu’il est important d’investir en soi pour franchir de nouveaux caps."); ?></h5>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="title col-md-12 col-lg-12 d-flex align-items-center justify-content-center">
					<h4 class="mbr-section-subtitle align-center mbr-fonts-style mb-0 display-2"><strong><?php echo tt("Découvrez nos équipes"); ?></strong></h4>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="item features-image сol-12 offset-lg-3 col-md-6 col-lg-3 active " style="display: inline-block;margin-bottom: 33px!important;">
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4"><?php echo tt("Directeur technique - Co founder SPACEKOLA"); ?></p>
						</div>
					</div>
				</div>
				<div class="item features-image сol-12 col-md-6 col-lg-3 active " style="display: inline-block;margin-bottom: 33px!important;">
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4"><?php echo tt("Expert comptable - CEO & Founder at FLOWEXCO"); ?></p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="item features-image сol-12 col-md-6 col-lg-3 active">
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4"><?php echo tt("Chargée de Relation Client"); ?></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container-fluid" style="background: #f4f9fe;padding-top: 34px;padding-bottom: 34px;padding-left:0px!important;padding-right: 0px!important;margin-bottom: 33px!important;display:none!important;">
			<div class="row" style="margin-top: 1rem!important;">
				<div class="col-12" style="text-align: center">
					...
					<p style="font-size: 20px!important; margin-top: 1rem"><?php echo tt("EVODROIT a conseillé et accompagné LS2EC TRAINING"); ?> <br> <?php echo tt("dans la modification de son actionnariat"); ?></p>
				</div>
			</div>
				...
				<div class="item features-image сol-12 offset-lg-3 col-md-6 col-lg-3 active ">
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4"><?php echo tt("Avocat Associé"); ?></p>
						</div>
					</div>
				</div>
				<div class="item features-image сol-12 col-md-6 col-lg-3 active">
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4"><?php echo tt("Avocat"); ?></p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="item features-image сol-12 col-md-6 col-lg-3 active">
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4"><?php echo tt("Formateur Cisco CCNA et Fortinet NSE4"); ?></p>
						</div>
				...
				<div class="item features-image сol-12 col-md-6 col-lg-3">
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4"><?php echo tt("Formateur Cisco CCNP"); ?></p>
						</div>
				...
				<div class="item features-image сol-12 col-md-6 col-lg-3">
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4"><?php echo tt("Formation Fortinet NSE7"); ?></p>
						</div>
					...
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4"><?php echo tt("Formatrice Cybersécurité"); ?></p>
						</div>
			...
			<div class="row justify-content-center">
				<div class="col-12 align-center col-lg-8">
					<h1 class="mbr-section-title mbr-fonts-style mb-3 display-5">
						<strong>
							<?php echo tt("Devenir consultant en cybersécurité en 3 étapes simples et gagner jusqu’à 500€ (327000 Fr CFA) par jour ?"); ?>&nbsp;
						</strong><strong><?php echo tt("C'est possible grâce au système LS2EC Training."); ?></strong></h1>


					<div class="mbr-section-btn mt-3"><a class="btn btn-primary display-5" href="https://forms.aweber.com/form/02/851692102.htm"><span class="mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span><strong><?php echo tt("Testez notre système gratuitement"); ?></strong></a></div>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row justify-content-center">
				<div class="col-12 col-md-">
					<div class="section-head align-center">
						...
						<h4 class="mbr-section-subtitle mbr-fonts-style display-2"><?php echo tt("Foire aux questions"); ?></h4>
					</div>
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse1_27" aria-expanded="false" aria-controls="collapse1">
									<h6 class="panel-title-edit mbr-fonts-style display-5">“<?php echo tt("Est-ce que je peux vraiment gagner 500€/jour chez un client ?"); ?>”</h6>
							...
							<div id="collapse1_27" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-4">
										<?php echo tt("Oui absolument pour un profil junior entre 0 et 3 ans en France dans le domaine de la cybersécurité c'est le tarif journalier moyen qui est payé aux freelances ou indépendants. Pour plus d'informations sur les salaires possibles en cybersécurité, visitez ce site"); ?>
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse2_27" aria-expanded="false" aria-controls="collapse2">
									<h6 class="panel-title-edit mbr-fonts-style display-5">“<?php echo tt("Quelle différence entre ce programme de formations et les centaines qui existent déjà en ligne ou dans les écoles ?"); ?>”</h6>
									<span class="mbr-iconfont mobi-mbri-plus mobi-mbri display-4"></span>
								</a>
							</div>
							<div id="collapse2_27" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-4"><?php echo tt("La différence fondamentale réside dans l’approche pédagogique.."); ?><br><?php echo tt("Chez nous, l'expertise en cybersécurité se développe étape-par-étape en tenant compte des personnes qui n'ont jamais été techniques mais qui développent une envie de monter en compétences en cybersécurité."); ?> <br><br><?php echo tt("On ne vous plonge pas directement dans la cybersécurité sans passer par les bases en réseaux et sécurité informatique. D'où le fait que nous nous définissons comme le système vers l'expertise en cybersécurité en 3 étapes."); ?><br>
									</p>
								</div>
							</div>
						</div>
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse3_27" aria-expanded="false" aria-controls="collapse3">
									<h6 class="panel-title-edit mbr-fonts-style display-5">“<?php echo tt("Combien de temps me faudra-t-il pour me former ?"); ?>”</h6>
									<span class="mbr-iconfont mobi-mbri-plus mobi-mbri display-4"></span>
								</a>
							</div>
							<div id="collapse3_27" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-4"><?php echo tt("Il vous faut minimum 6 mois et maximum 1 an pour vous former en suivant notre méthode."); ?><br>
									</p>
								</div>
							</div>
						</div>
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse4_27" aria-expanded="false" aria-controls="collapse4">
									<h6 class="panel-title-edit mbr-fonts-style display-5">“<?php echo tt("Aurais-je le temps entre ma vie professionnelle et ma vie familiale pour une formation ?"); ?>”</h6>
									<span class="mbr-iconfont mobi-mbri-plus mobi-mbri display-4"></span>
								</a>
							</div>
							<div id="collapse4_27" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-4"><?php echo tt("Nous avons pensé à vous , et justement la recommandation que nous faisons c'est de travailler 1h-2h/jour. En plus, vous avez la chance d'appartenir à notre groupe privé Facebook pour vous motiver à poursuivre et à y aller jusqu'au bout."); ?><br>
									</p>
								</div>
							</div>
						</div>
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse5_27" aria-expanded="false" aria-controls="collapse5">
									<h6 class="panel-title-edit mbr-fonts-style display-5">“<?php echo tt("Quels sont les prérequis pour rejoindre ce programme ?"); ?>”</h6>
									<span class="mbr-iconfont mobi-mbri-plus mobi-mbri display-4"></span>
								</a>
							</div>
							<div id="collapse5_27" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-4"><?php echo tt("Que vous ayez ou pas de solides bases en informatique, nos formateurs utilisent des méthodes pédagogiques pour vulgariser les concepts complexes en des termes vraiment simples."); ?><br>
									</p>
								</div>
							</div>
						</div>
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse6_27" aria-expanded="false" aria-controls="collapse6">
									<h6 class="panel-title-edit mbr-fonts-style display-5">“<?php echo tt("Pendant combien de temps ai-je accès à la formation ?"); ?>”</h6>
									<span class="mbr-iconfont mobi-mbri-plus mobi-mbri display-4"></span>
								</a>
							</div>
							<div id="collapse6_27" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-4"><?php echo tt("Vous avez accès à la formation en illimité pendant un an sous réserve d’avoir finalisé votre paiement. En cas de défaut de paiement, les accès sont bloqués."); ?> <br><br><?php echo tt("Nous limitons l’accès à un an pour vous inciter à finir votre formation en moins d’un an et atteindre vos objectifs professionnels sans procrastiner."); ?><br>
									</p>
								</div>
							</div>
						</div>
	...
	<section data-bs-version="5.1" class="contacts1 cid-tgtDcVqYZq" id="contacts1-2r">
		...
		<div class="container">
			<div class="mbr-section-head">
				<h2 class="mbr-section-title mbr-fonts-style align-center display-5"><?php echo tt("Vous avez une question ?"); ?></h2>
			</div>
			<div class="row justify-content-center ">
				<div class="card col-12 col-md-6">
					<div class="card-wrapper">
						...
						<div class="text-wrapper">
							<h6 class="card-title mbr-fonts-style display-5"><?php echo tt("Envoyez-nous un email à"); ?></h6>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layoutnewlook', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yvafrkyk/public_html/web/views/about.blade.php ENDPATH**/ ?>