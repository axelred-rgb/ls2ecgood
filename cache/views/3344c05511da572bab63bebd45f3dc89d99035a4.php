...
gtag('config', 'AW-332951563');
    ...
    <!-- Style-->
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/css/dv_style.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/css/stylesheet.css">

    <!-- Vendors Style-->
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/css/vendors_css.css">

    <!-- Style-->
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/css/style.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/css/skin_color.css">

    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/css/select2.min.css">


    <link rel="icon" href="<?php echo e(assets); ?>newlook/logo.ico" type="image/icon type">
    ...
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/web/assets/mobirise-icons2/mobirise2.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/web/assets/mobirise-icons/mobirise-icons.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/web/assets/mobirise-icons-bold/mobirise-icons-bold.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/bootstrap/css/bootstrap-grid.min.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/bootstrap/css/bootstrap-reboot.min.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/parallax/jarallax.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/socicon/css/styles.css">
    <link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/theme/css/style.css">
    ...
    <link rel="preload" as="style" href="<?php echo e(assets); ?>newlook/assets/mobirise/css/mbr-additional.css"><link rel="stylesheet" href="<?php echo e(assets); ?>newlook/assets/mobirise/css/mbr-additional.css" type="text/css">
...
<a aria-label="" href="https://wa.me/33651957624"> <img alt="Chat on WhatsApp" src="<?php echo e(assets); ?>images/whatsapp.png" /> </a>
</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12">
                    <div class="widget">
                        <h4 class="footer-title"><?php echo tt("C'est quoi LS2EC TRAINING ?"); ?></h4>
                ...
                <div class="col-lg-4 col-12">
                    <div class="widget">
                        ...
                        <ul class="list list-unstyled mb-30">
                            ...
                            <li> <i class="fa fa-mail"></i> <span>info@ls2ec.com</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-12">
...
<?php /**PATH /home/yvafrkyk/public_html/web/views/layoutnewlook.blade.php ENDPATH**/ ?>