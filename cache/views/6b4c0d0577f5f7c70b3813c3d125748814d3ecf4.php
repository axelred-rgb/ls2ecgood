...
<header class="top-bar">
    ...
    padding: unset;
">
                <img src="<?php echo e(assets); ?>images/logo-training.png" alt="" style="
    margin-top: -25px;"/>
            </a>
        </div>
        ...
        <ul class="menu">
            ...
            <li id="lo" style="margin-left:20px">
                <span>Login: </span> <?php echo e($u_labs->labs_keys->login); ?>

            </li>
            <li id="pw" style="margin-left:5px">
                <span>Password: </span> <?php echo e($u_labs->labs_keys->password); ?>
...
<section class="py-50 bg-white" style="padding-bottom:0px!important">
  ...
  background-clip: content-box, padding-box;padding:20px; text-align:center" hidden width="100%" height="700">
        ...
        <img src="<?php echo e(assets); ?>images/labs_time_is_over.png" alt="" height="700"  />

    </section>
    <?php elseif($startlab == 0): ?>
        <div class="alert alert-info"><?php echo tt("Your session is scheduled from :from to :to ", ["from"=>$u_labs->date, "to"=>$u_labs->datefin]); ?> </div>
    <?php elseif($startlab == -1): ?>
        <div class="alert alert-info"><?php echo tt("Your session has expired"); ?></div>
    <?php endif; ?>
...
<script>
        ...
        function openAlert(){
            $.jAlert({
                'title':'<?php echo tt("Time is Over"); ?>',
                'content': "<?php echo tt('Do you want to schedule a new lab?'); ?> ?.<br>",
                'theme': 'red',
                'btns': [
		...
		countdownManager = {
			...
			tick: function(time = 0){
                ...
                var timeNow  = new Date('<?php echo e(gmdate("Y-m-d H:i")); ?>');;
 ...
 //alert(timeNow);
		...
		jQuery(function($){
            ...
            <?php if($startlab == 1): ?>
			    countdownManager.init("<?php echo e($u_labs->datefin); ?>");
            <?php endif; ?>
		});
...
<?php /**PATH /home/yvafrkyk/public_html/web/views/board/showlabs.blade.php ENDPATH**/ ?>