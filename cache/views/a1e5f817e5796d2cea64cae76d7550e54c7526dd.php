			...
			<div class="row">
				<div class="col-12">
					<div class="text-center">
						<br>
						<br>
						<p class="page-title text-white" style="font-size: 3rem;"><?php echo tt("Formez vos consultants et signez vos meilleurs clients"); ?></p>
			...
			<div class="row justify-content-center">
				<div class="col-12">
					<div class="text-center no-border">
						<h1 class="box-title" ><?php echo tt("La meilleure formation pour vos consultants en cyber sécurité"); ?></h1>
						<div class="row">
							<div class="offset-5 col-2">
								<a type="button"   href="https://calendly.com/claudemarcelbiyihamang/prendre-un-rendez-vous"   class="btn btn-sm btn-info w-p100 mt-15"><?php echo tt("Prendre rendez vous"); ?></a>
			...
			<div class="row justify-content-center">
				...
				<div class="col-xl-6 col-sm-12">
					<div class="box box-body" style="text-align: center;">
						<div class="box-body">
							<img src="<?php echo e(assets); ?>images/avatar/economic.png" alt="..." >
							<br>
							<h1 class="mb-15"><?php echo tt("Augmenter votre chiffre d’affaires "); ?></h1>
							<p class="fs-20" style="text-align: justify">
								<?php echo tt("Un consultant bien formé est plus qualifié et donc plus cher."); ?></p>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-6 col-sm-12">
					<div class="box box-body" style="text-align: center;">
						<div class="box-body">
							<img src="<?php echo e(assets); ?>images/avatar/economic.png" alt="..." style="width: 128px; height: 128px;">
							<br>
							<h1 class="mb-15"><?php echo tt("Avoir une meilleure réputation que vos concurrents "); ?></h1>
							<p class="fs-20" style="text-align: justify"><?php echo tt("Plus vos consultants sont formés, plus ils sont performants dans leur missions et plus vos clients sont satisfaits. Le bouche à oreille va devenir votre meilleur source d'acquisition ."); ?></p>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-6 col-sm-12" style="text-align: center;">
					<div class="box box-body">
						<div class="box-body" >
							<img src="<?php echo e(assets); ?>images/avatar/sustainability.png" alt="..." style="max-width: 150px;" >
							<br>
								<h1 class="mb-15"><?php echo tt("Réduisez votre turn-over "); ?></h1>
							<br>
							<p class="fs-20" style="text-align: justify"><?php echo tt("En moyenne 36 % des personnes formées quittent moins leur entreprise. Si vous formez vos équipes, elle resteront plus longtemps = gain de temps, pérennité..."); ?></p>
					...
					<div class="box box-body p-xl-50 p-30">
						<div class="row">
							<div class="offset-4 col-4 justify-content-center">
								<a type="button"   href="https://calendly.com/claudemarcelbiyihamang/prendre-un-rendez-vous"   class="btn btn-lg btn-info w-p100 mt-15"><?php echo tt("Prendre rendez vous"); ?></a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yvafrkyk/public_html/web/views/enterprise.blade.php ENDPATH**/ ?>