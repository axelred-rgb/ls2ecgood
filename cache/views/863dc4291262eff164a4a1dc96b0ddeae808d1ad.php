...
<div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
    ...
    <?php echo $__env->make("layout.navbartop", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <div class="app-main">

        <?php if(\dclass\devups\Controller\Controller::$sidebar): ?>
            <?php echo $__env->make("layout.navbar", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>

        <div class="<?php echo e(\dclass\devups\Controller\Controller::$sidebar ? 'app-main__outer' : ""); ?>">
...
<?php /**PATH /home/yvafrkyk/public_html/admin/views/layout/layout.blade.php ENDPATH**/ ?>