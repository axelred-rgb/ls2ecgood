            ...
            <table class="order-data-addresses" style="background: #0b8e36;color:#ffffff;padding: 10px; width: 80%!important;min-width: 250px">
                <tr>
                    <td class="address billing-address" style="padding:20px">
                        ...
                        <?php echo e($user->getFirstname()); ?> <?php echo e($user->getLastname()); ?><br>
                        <?php echo e($user->getTelephone()); ?><br><?php echo e($user->getEmail()); ?>
...
<?php /**PATH /home/yvafrkyk/public_html/web/views/layout/layoutfacturesortie.blade.php ENDPATH**/ ?>