        ...
        <div class="row">
            <div class="col-sm-12">
                <form action="" class="form-control">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <label for="descriptionFr"><?php echo tt("Description (Fr)"); ?></label>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12" >
                            <label for="descriptionEn"><?php echo tt("Description (En)"); ?></label>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <button class="btn btn-md btn-success" onclick="app.createPost(this)" type="button" style="width:100%"><?php echo tt("Save"); ?></button>                        
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('board.layoutboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yvafrkyk/public_html/web/views/board/manageBlog/createpost.blade.php ENDPATH**/ ?>