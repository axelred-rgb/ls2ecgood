			...
			<div class="row">
				<div class="col-12">
					<div class="text-center">						
						<h2 class="page-title text-white">@tt("Blog")</h2>
					...
					<div class="box">
						...
						<div class="row g-0">
							...
							<div class="col-md-8 col-12">
								<div class="box-body">
									<h4><a href="{{route('blog')}}?id={{$articles->getId()}}">{{$articles->getTitle()}}</a></h4>
									...
									<div class="flexbox align-items-center mt-3">
										<a class="btn btn-sm btn-primary" href="{{route('blog')}}?id={{$articles->getId()}}">@tt("Read more")</a>
