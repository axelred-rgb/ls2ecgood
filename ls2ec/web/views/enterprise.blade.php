			...
			<div class="row">
				<div class="col-12">
					<div class="text-center">
						<br>
						<br>
						<p class="page-title text-white" style="font-size: 3rem;">@tt("Passeport pour votre transformation digitale")</p>
		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<div class="text-center no-border">
					<h1 class="box-title" >@tt("Confiez nous les cerveaux de vos collaborateurs")</h1>
				</div>
				</div>
				<div class="col-xl-6 col-sm-12" style="text-align: center;">
					<div class="box box-body">
						<div class="box-body" >
							<img src="{{ assets   }}images/avatar/notoriety.png" alt="..." >
							<br>
								<h1 class="mb-15">@tt("Notoriété")</h1>
							<br>
							<p class="fs-20" style="text-align: justify">@tt("desc1_avantage1","En nous confiant les cerveaux de vos collaborateurs qui représentent votre plus gros actif, vous consoliderez voire augmenterez votre notoriété auprès de vos clients.")</p>
							<p class="fs-20" style="text-align: justify">@tt("desc2_avantage1","LS2EC TRAINING utilise une méthode de formation pragmatique, pédagogique basée sur des illustrations imagées et des cas pratiques tirés de nos propres expériences en tant qu’ingénieurs et architectes auprès de la plupart des clients grands compte en France. Bien plus nos formateurs sont certifiés Cisco et Fortinet.")
								</p>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-6 col-sm-12">
					<div class="box box-body" style="text-align: center;">
						<div class="box-body">
							<img src="{{ assets   }}images/avatar/sustainability.png" alt="..." style="width: 128px; height: 128px;">
							<br>
							<h1 class="mb-15">@tt("Avantage Compétitif durable")</h1>
							<p class="fs-20" style="text-align: justify">@tt("Votre notoriété va avoir un impact direct sur votre avantage compétitif qui sera de plus en plus durable car vos collaborateurs seront votre gage de confiance, de compétence et de qualité.")</p>
						</div>
					</div>
				</div>
				<div class="col-xl-6 col-sm-12">
					<div class="box box-body" style="text-align: center;">
						<div class="box-body">
							...
							<br>
							<h1 class="mb-15">@tt("Rentabilité")</h1>
							<p class="fs-20" style="text-align: justify">@tt("Qui dit avantage compétitif durable dit forcément rentabilité car vos collaborateurs seront de plus en plus sollicités.")</p>
					...
					<div class="box box-body p-xl-50 p-30">
						<div class="row align-items-center">
							<div class="col-lg-12 col-12 text-center">
								<h1 class="mb-15">@tt("Welcome Gifts")</h1>
								<h4 class="fw-400">@tt("Télécharger les livres blancs.")</h4>
							</div>
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-12 position-relative">
								<div class="media-list media-list-hover media-list-divided md-post mt-lg-0 mt-30">
									<a class="media media-single box-shadowed bg-white pull-up mb-15" href="{{route('downloadbookent')}}?id=1">
										<img class="w-80 rounded ms-0" src="{{ assets   }}images/avatar/cybersecurity.png" alt="...">
										<div class="media-body fw-500">
											<h5 class="overflow-hidden text-overflow-h nowrap">@tt("Cyber Security")</h5>

											<p><small class="text-fade mt-10">LS2EC</small></p>
										</div>
									</a>
									<a class="media media-single box-shadowed bg-white pull-up mb-15" href="{{route('downloadbookent')}}?id=2">
										<img class="w-80 rounded ms-0" src="{{ assets   }}images/avatar/dna.jpg" alt="...">
										<div class="media-body fw-500">
											<h5 class="overflow-hidden text-overflow-h nowrap">@tt("Digital Network </br>Architecture (DNA)")</h5>
											<p><small class="text-fade mt-10">LS2EC</small></p>
										</div>
									</a>
									<a class="media media-single box-shadowed bg-white pull-up mb-15" href="{{route('downloadbookent')}}?id=3">
										<img class="w-80 rounded ms-0" src="{{ assets   }}images/avatar/na.jpg" alt="...">
										<div class="media-body fw-500">
											<h5 class="overflow-hidden text-overflow-h nowrap">@tt("Network Automation")</h5>
											<p><small class="text-fade mt-10">LS2EC</small></p>
										</div>
									</a>
								</div>
							...
							<div class="col-lg-6 col-12 position-relative">
								<div class="media-list media-list-hover media-list-divided md-post mt-lg-0 mt-30">
									<a class="media media-single box-shadowed bg-white pull-up mb-15" href="{{route('downloadbookent')}}?id=4">
										<img class="w-80 rounded ms-0" src="{{ assets   }}images/avatar/sase.jpg" alt="...">
										<div class="media-body fw-500">
											<h5 class="overflow-hidden text-overflow-h nowrap">@tt("Secure Access Service Edge (SASE)")</h5>

											<p><small class="text-fade mt-10">LS2EC</small></p>
										</div>
									</a>
									<a class="media media-single box-shadowed bg-white pull-up mb-15" href="{{route('downloadbookent')}}?id=5">
										<img class="w-80 rounded ms-0" src="{{ assets   }}images/avatar/sda.jpg" alt="...">
										<div class="media-body fw-500">
											<h5 class="overflow-hidden text-overflow-h nowrap">@tt("Software Defined Access (SD-Access)")</h5>
											<p><small class="text-fade mt-10">LS2EC</small></p>
										</div>
									</a>
									<a class="media media-single box-shadowed bg-white pull-up mb-15" href="{{route('downloadbookent')}}?id=6">
										<img class="w-80 rounded ms-0" src="{{ assets   }}images/avatar/sdw.jpg" alt="...">
										<div class="media-body fw-500">
											<h5 class="overflow-hidden text-overflow-h nowrap">@tt("Software Defined WAN (SD-WAN)")</h5>
											<p><small class="text-fade mt-10">LS2EC</small></p>
										</div>
									</a>
								</div>
