		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-7 col-12">
					<h2 class="mb-10">@tt("Who are we")</h2>
					<h4 class="fw-400"></h4>
					<p class="fs-16">
						...
						<br>
						<br>	@tt("Aujourd’hui les entreprises sont de plus en plus exigeantes et ont de plus en plus difficultés à trouver les profils qui leur sied.")
						<br>
						<br>	@tt("LS2EC TRAINING est la solution qui permettra à vous, entreprises IT, d’augmenter votre notoriété auprès de vos clients, d’augmenter votre chiffre d’affaires par la qualité des cerveaux de vos collaborateurs qui représentent votre plus gros actif, et à vous les profils jeunes étudiants, juniors d’augmenter votre niveau de confiance à vos entretiens d’embauche.")
						<br>
						<br>	@tt("Nous nous engageons sur les périmètres réseaux (LAN, MAN,WAN) , Sécurité, Cybersécurité, Cloud, Devops Automatisation, à vous garantir les  3 promesses suivantes :")
						<br>	- @tt("De bâtir des ingénieurs confiants")
						<br>	- @tt("De bâtir des ingénieurs compétents et en veille technologique")
						<br>	- @tt("De bâtir des ingénieurs en capacité de vulgariser leurs savoir-faire.")
						<br>
						<br>
					<a href="{{ route('contact') }}" class="btn btn-primary">@tt("Contact Us")</a>
				</div>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<a href="#" class="pull-up">
						<div class="p-10">
							...
							<h3 class="my-15">@tt("Our Slogan")</h3>
							<div class="text-fade fs-16 mb-10">@tt("L'Expertise c'est notre garantie.")</div>
						</div>
					</a>
				</div>
				<div class="col-lg-3 col-md-6 col-12">
					<a href="#" class="pull-up">
						<div class="p-10">
							...
							<h3 class="my-15">@tt("Our Mission")</h3>
							<div class="text-fade fs-16 mb-10">@tt("Perpétuer la transmission des savoirs techniques en réseau, sécurité, cybersécurité et cloud.")</div>
						</div>
					</a>
				</div>
				<div class="col-lg-3 col-md-6 col-12">
					<a href="#" class="pull-up">
						<div class="p-10">
							...
							<h3 class="my-15">@tt("Our Vision")</h3>
							<div class="text-fade fs-16 mb-10">@tt("Conquérir le monde à travers notre méthode d’enseignement unique basée sur nos valeurs fortes.")</div>
						</div>
					</a>
				</div>
				<div class="col-lg-3 col-md-6 col-12">
					<a href="#" class="pull-up">
						<br class="p-10">
							...
							<h3 class="my-15">@tt("Nos valeurs")</h3>
							<div class="text-fade fs-16 mb-10">@tt("Passion - Pédagogie - Créativité")</div>
						</div>
					</a>
				</div>
			</div>
