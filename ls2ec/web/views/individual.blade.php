			...
			<div class="row">
				<div class="col-12">
					<div class="text-center">
						<br>
						<br>
						<h2 class="page-title text-white" style="font-size: 3rem;">@tt("Le chemin de l'excellence")</h2>
				...
				<div class="col-xl-6 col-sm-12" style="text-align: center;">
					<div class="box box-body">
						<div class="box-body" >
							...
							<br>
							<p class="fs-22" style="text-align: justify">@tt("desc1_i_avantage1","Nous vous garantissons la compétence, car nos  formateurs utilisent une pédagogie créative basée des illustrations par l’image et par des exemples concrets et pratiques sur les problèmes rencontrés en entreprise.")</p>
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-12 position-relative">
								<div class="media-list media-list-hover media-list-divided md-post mt-lg-0 mt-30">
									<a class="media media-single box-shadowed bg-white pull-up mb-15" href="{{route('downloadbook')}}?id=2">
										<img class="w-80 rounded ms-0" src="{{ assets   }}images/avatar/dna.jpg" alt="...">
										<div class="media-body fw-500">
											<h5 class="overflow-hidden text-overflow-h nowrap">@tt("Digital Network Architecture (DNA)")</h5>
											<p><small class="text-fade mt-10">LS2EC</small></p>
										</div>
									</a>
									<a class="media media-single box-shadowed bg-white pull-up mb-15" href="{{route('downloadbook')}}?id=3">
									...
									<a class="media media-single box-shadowed bg-white pull-up mb-15" href="{{route('downloadbook')}}?id=5">
