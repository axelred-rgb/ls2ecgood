...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center mt-80">
                        <h1 class="box-title text-white mb-30">@tt("LS2EC TRAINING - L'Expertise c'est notre garantie")</h1>
                        <br>
                        <br>
                    </div>
                    </div>
                            ...
                            <div class="box box-body p-xl-50 p-30 bg-lightest">
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        ...
                                        <h4 class="fw-400">@tt("votre transformation digitale vous tient-elle à cœur dans
                                            les domaines des réseaux, sécurité, cybersécurité, cloud, devops ?")</h4>
                                        <br>
                                        <h4 class="fw-400">@tt("LS2EC TRAINING est la solution pour booster votre notoriété auprès de vos clients,
                ...
                <div class="col-md-6 col-12">
                        <div class="box box-body p-xl-50 p-30 bg-lightest">
                            <div class="row align-items-center">
                                <div class="col-12">
                                    <h1 class="mb-15">@tt("Aux Particuliers")</h1>
                                    <h4 class="fw-400">@tt("Technicien(ne)s et ingénieur(e)s réseaux, sécurité, cybersécurité, cloud, devops,
                                        votre degré de confiance à vos entretiens d’embauche vous tient-il à cœur ?")</h4>
                                    <br>
                                    <h4 class="fw-400">@tt("LS2EC TRAINING est la solution qui vous garantit l’excellence pour que désormais
    ...
    <section class="py-50 aos-init aos-animate">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 col-12 text-center">
                    <h1 class="mb-15">@tt("Our Clients")</h1>
                    <hr class="w-100 bg-primary">
                </div>
            </div>
            <div class="row mt-30">
                ...
                <div class="col-5"></div>
                <div class="col-2" ><img src="{{ assets   }}images/front-end-img/unilogo/uni-1.jpg" style="width: 199.833px; margin-right: 20px;"></div>
                <div class="col-2"></div>
