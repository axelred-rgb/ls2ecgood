<?php 
    ...
    class Paiement extends Model implements JsonSerializable{
         ...
         * @param int $nbremonth
         */
        public function setNbremonth(  $nbremonth)
        {
        ...
        public function __insert()
        {
            ...
            if($this->subscription->getTarget() == 'pecb'){

                if($this->subscription->getType() == 3){
                    $this->setDetails("Avec formateur");
                }
                elseif ($this->subscription->getType() == 4){
                    $this->setDetails("Sans formateur");
                }
            }
