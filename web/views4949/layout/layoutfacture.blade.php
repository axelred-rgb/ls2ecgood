...
<table class="head container" style="margin-bottom: 10px!important;width: 40%!important;">
    ...
    <tr style="padding:5px!important;">
        <td style="border-left: 1px solid #ddd1d1;padding-left: 10px;">
            <span style="color: #0b8e36;font-weight: bold">@tt("Date de facturation")</span> <br>
            {{$paiement->getCreatedAt()}}
        </td>
        {{--        <td style="border-left: 1px solid #ddd1d1;padding-left: 10px;">--}}
        {{--            <span style="color: #0b8e36;font-weight: bold">@tt("Date d'echeance")</span> <br>--}}
        {{--            {{$paiement->getCreatedAt()}}--}}
        {{--        </td>--}}
        <td style="border-left: 1px solid #ddd1d1;padding-left: 10px;">
            <span style="color: #0b8e36;font-weight: bold">@tt("Statut")</span> <br>
            Payé
        </td>
