                ...
                <form action="" class="form-control" id="createexercise">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 form-group" ckeditor="ckeditor" data-id="contenu_en">
                            ...
                            <textarea name="contenu_en" id="contenu_en" class="form-control" cols="30" rows="10"></textarea>
                            <label for="" class="errormessage"></label>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 form-group" ckeditor="ckeditor" data-id="reponse_en">
                            ...
                            <textarea name="reponse_en" id="reponse_en" cols="30" rows="10" class="form-control"></textarea>
                            <label for="" class="errormessage"></label>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <button class="btn btn-md btn-success" onclick="app.createsimpleObject(this,'exercise','createexercise','manageexercise')" type="button" style="width:100%">@tt("Save")</button>
                        </div>
                    </div>
                </form>
            </div>
