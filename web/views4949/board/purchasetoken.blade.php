...
@section('content')
    ...
    <div class="tab-pane fade show active" id="pills-purshase-token" role="tabpanel" aria-labelledby="pills-purshase-token-tab">
        ...
        <div class="bg-img box box-body py-50" style="background-image: url({{ assets   }}images/front-end-img/banners/banner-1.jpg)" data-overlay="7">
            ...
            <div class="row" class="form align-items-center cours-search max-w-950">
                <div class="col-12">
                    <div id="paypalbtn" hidden  style="text-align:center">

                    </div>
                </div>
                <div class="col-12" id="cinetpaycontent" hidden style="text-align:center">
                    <select name="" id="devise" style="width: 30%;
    height: 55px;
    ...
    border-radius: 5px;">
                    ...
                    <button id="cinetpay" style="width: 55%;
    height: 55px;
    border-radius: 5px;
    background-color: #0b8e36;
    border: 2px solid #0b8e36;
    color: #ffffff;" onclick="">@tt('Mobile money')</button>
                </div>
            </div>
