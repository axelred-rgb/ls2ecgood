        ...
        <div class="bg-img box box-body py-50" style="background-image: url({{ assets   }}images/front-end-img/banners/banner-1.jpg)" data-overlay="7">
            ...
            <div class="row">
                ...
                <div class="form col-6 g-0 align-items-center cours-search">
                    <button onclick="app.updateUser(this)"  class="btn w-p100 btn-danger rounded-0">@tt("Update")</button>
        ...
        <div class="bg-img box box-body py-50" style="background-image: url({{ assets   }}images/front-end-img/banners/banner-1.jpg)" data-overlay="7">
            ...
            <div class="row">
                ...
                <div class="form col-6 g-0 align-items-center cours-search" hidden="hidden"  id="updatephonecountry">
                    <button  onclick="app.updatephonorcountrystep2(this)"  class="btn w-p100 btn-danger rounded-0">@tt("Update")</button>
                </div>
            ...
            <div class="row">
                ...
                <div class="form col-6 g-0 align-items-center cours-search">
                    ...
                    <button onclick="app.updatephonorcountrystep1(this)"  class="btn w-p100 btn-danger rounded-0">@tt("Send activation code")</button>
                </div>
            </div>
        </div>
