			...
			<div class="row">
				<div class="col-12">
					<div class="text-center">						
						<h2 class="page-title text-white">@tt("Contact us")</h2>
			...
			<div class="row align-items-center">
				<div class="col-md-7 col-12">
					<form method="post" id="contact-form" >
						<div class="text-start mb-30">
							<h2>@tt("Get In Touch")</h2>
							<p></p>
						</div>
						<div class="row">
						  <div class="col-md-6">
							<div class="form-group">
							  <input type="text" name="firstname" class="form-control" placeholder="@tt('First Name')">
							</div>
						  </div>
						  <div class="col-md-6">
							<div class="form-group">
							  <input type="text" name="lastname" class="form-control" placeholder="@tt('Last Name')">
							</div>
						  </div>
						  <div class="col-md-6">
							<div class="form-group">
							  <input type="email" name="email" class="form-control" placeholder="@tt('Your Email')" required>
							</div>
						  </div>
						  <div class="col-md-6">
							<div class="form-group">
							  <input type="tel" name="phone" class="form-control" placeholder="@tt('Phone')">
							</div>
						  </div>
						  <div class="col-md-6">
							<div class="form-group">
							  <input type="text" name="subject" class="form-control" placeholder="@tt('Subject')" required>
							</div>
						  </div>
						  ...
						  <div class="col-lg-12">
							  <button type="button" onclick="app.contactform(this)" class="btn btn-info w-p100 mt-15">@tt("Envoyer")</button>
							 </div>
						</div>
					</form>
				</div>
				<div class="col-md-5 col-12 mt-30 mt-md-0">
					<div class="box box-body p-40 bg-dark mb-0">
						<h2 class="box-title text-white">@tt("Contact Info")</h2>
						<p></p>
						...
						<h4 class="mb-20">@tt("Follow Us")</h4>
