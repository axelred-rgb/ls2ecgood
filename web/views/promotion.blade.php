        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-2 col-md-10 col-sm-10 col-sm-offset-2">
                    ...
                    <h1 class="wow bounceInUp" style="font-weight: bold" data-wow-delay="1s">{{$actual_event[1]}}</h1>
                </div>
        ...
        <div class="container">
            <div class="row" >
                <div class="col-md-12 col-sm-12 countdown-des">
                    <h2 class="wow bounceIn" data-wow-delay="1.9s">@tt("Promotion spéciale") {{$actual_event[1]}}</h2>
                    <h1 style="display: none">@tt("Pour les amoureux de la cybersécurité")</h1>
                    <p></p>
            ...
            <div class="row">
                ...
                <div class="col-sm-12" style="background: #f5f5f5; padding:60px 80px;">
                    <h4 style="color: #0b8e36!important;text-align: center;font-size: 30px;text-transform: initial">
                        @tt("Plongez dans l'univers de la cybersécurité et forgez votre expertise grâce à nos offres unique")
                    </h4>
                    <div class="row mt-40">
                            ...
                            <div class="box ribbon-box">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        @if(App::$user->getId())
                                            <button onclick="showformpaiement('product-line1','p')" class="btn btn-primary">@tt("Acheter")</button>
                                        @else
                                            <a href="{{route('login')}}" class="btn btn-primary">@tt("Connectez vous pour acheter")</a>
                                        @endif
                                    </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="box ribbon-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="text-center">
                                        <h3 class="my-10"><a href="#">@tt("2000 jetons")</a></h3>
                                        <h2 style="font-size: 1.3rem">
                                            <span style="text-decoration: line-through">800 €</span>
                                            450 €
                                        </h2>
                                        @if(App::$user->getId())
                                            <button onclick="showformpaiement('product-line1','p2')" class="btn btn-primary">@tt("Acheter")</button>
                                        @else
                                            <a href="{{route('login')}}" class="btn btn-primary">@tt("Connectez vous pour acheter")</a>
                                        @endif
                                    </div>
                            ...
                            <div class="box ribbon-box">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="my-10"><a href="#">@tt("1000 jetons")</a></h3>
                                        <h2 style="font-size: 1.3rem">
                                            <span style="text-decoration: line-through">400 €</span>
                                            250 €
                                        </h2>
                                        @if(App::$user->getId())
                                            <button onclick="showformpaiement('product-line1','p1')" class="btn btn-primary">@tt("Acheter")</button>
                                        @else
                                            <a href="{{route('login')}}" class="btn btn-primary">@tt("Connectez vous pour acheter")</a>
                                        @endif
                                    </div>
                            ...
                            <div class="box ribbon-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        @if(App::$user->getId())
                                            <button onclick="showformpaiement('product-line1','p3')" class="btn btn-primary">@tt("Acheter")</button>
                                        @else
                                            <a href="{{route('login')}}" class="btn btn-primary">@tt("Connectez vous pour acheter")</a>
                                        @endif
                                    </div>
                            ...
                            <div class="box ribbon-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        @if(App::$user->getId())
                                            <button onclick="showformpaiement('product-line2','p4')" class="btn btn-primary">@tt("Acheter")</button>
                                        @else
                                            <a href="{{route('login')}}" class="btn btn-primary">@tt("Connectez vous pour acheter")</a>
                                        @endif
                                    </div>
                            ...
                            <div class="box ribbon-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        @if(App::$user->getId())
                                            <button onclick="showformpaiement('product-line2','p5')" class="btn btn-primary">@tt("Acheter")</button>
                                        @else
                                            <a href="{{route('login')}}" class="btn btn-primary">@tt("Connectez vous pour acheter")</a>
                                        @endif
                                    </div>
                            ...
                            <div class="box ribbon-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        @if(App::$user->getId())
                                            <button onclick="showformpaiement('product-line2','p6')" class="btn btn-primary">@tt("Acheter")</button>
                                        @else
                                            <a href="{{route('login')}}" class="btn btn-primary">@tt("Connectez vous pour acheter")</a>
                                        @endif
                                    </div>
                            ...
                            <div class="box ribbon-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        @if(App::$user->getId())
                                            <button onclick="showformpaiement('product-line2','p7')" class="btn btn-primary">@tt("Acheter")</button>
                                        @else
                                            <a href="{{route('login')}}" class="btn btn-primary">@tt("Connectez vous pour acheter")</a>
                                        @endif
                                    </div>
...
@section("jsimport")
    ...
    @endif
        const targetDate = new Date('{{$actual_event[0]}}').getTime();
