			...
			<div class="row align-center justify-content-center">
				...
				<div class="card md-pb col-12 col-md-6 col-lg-4">
					<div class="card-wrapper">
						...
						<div class="card-box">
							<h5 class="card-title mbr-semibold pb-2 mbr-white mbr-fonts-style display-7">@tt("Vous avez de bonnes bases en informatique.")</h5>
	...
	<section data-bs-version="5.1" class="people2 bistro_people cid-tgRhQHqbEQ" id="people2-4g">
		...
		<div class="container">
			<div class="row" style="display: block; text-align: center">
				...
				<div class="item features-image сol-12  col-md-6 col-lg-3 active " style="display: inline-block">
					<div class="item-wrapper">
						...
						<div class="card_content text-center">
							...
							<p class="mbr-text px-2 mb-0 mbr-fonts-style display-4">@tt("Expert comptable - CEO & Founder at GLOWEXCO")</p>
						</div>
					</div>
				</div>
			</div>
			<div class="row" style="margin-top: 1rem!important;">
				<div class="col-12" style="text-align: center">
					...
					<p style="font-size: 20px!important; margin-top: 1rem">@tt("ENVODROIT a conseillé et accompagné LS2EC TRAINING") <br> @tt("dans la modification de son actionnariat")</p>
				</div>
			</div>
					...
					<div class="card-wrapper">
						...
						<div class="text-wrapper">
							...
							<p class="mbr-text mbr-fonts-style display-7">
								<a href="mailto:cm.biyihamang@ls2ec.com" class="text-primary">cm.biyihamang@ls2ec.com</a>
							</p>
						</div>
					</div>
				</div>
