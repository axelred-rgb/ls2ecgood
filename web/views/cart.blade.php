                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        @elseif($subscription->getTarget()=="pecb")
                                            <td>@tt("PECB")</td>
                                        @else
                                            <td>@tt("Enterprise")</td>
                                        @endif
                                        ...
                                        <td>
                                            @if(App::$user->getId())
                                                <span id="initprice">
                                                    {{$subscription->getM_price('check')}}
                                                </span>
                                                €
                                                @if($subscription->getMonth() > 0)
                                                    - {{$subscription->getMonth()}} @tt("Month")
                                                @endif
                                            @else
                                    ...
                                    <tr id="pricetotal_tr">
                                        <th colspan="{{$colspan}}" class="text-end">@tt("Total HT")</th>
                                        <th id="pricetotal">
                                            0 €
                                        </th>
                                    </tr>
                                    <tr id="pricetva_tr">
                                        <th colspan="{{$colspan}}" class="text-end">@tt("TVA") (20%)</th>
                                        <th id="pricetva">
                                            0 €
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="{{$colspan}}" class="text-end">@tt("Total TTC")</th>
                                        <th id="pricetotalttc">
                                            0 €
                                        </th>
                                    </tr>
...
@section("jsimport")
    ...
    <script>
        ...
        var initprice = parseFloat('{{$subscription->getM_price('check')}}');
        var inityear = parseFloat('{{$subscription->getY_price('check')}}');
        var initpricemonth = parseFloat('{{$subscription->getM_price('check')}}');
