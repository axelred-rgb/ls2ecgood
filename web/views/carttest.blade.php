...
@section("jsimport")
        ...
        @if(is_null($subscription->getPaypalplan()))
            ...
            <script src="https://www.paypal.com/sdk/js?client-id=AY6w8vKEOB8NEMOM_GWefUjf2R1SdsNkW4BqoRtJ_949nkWpdV2ye7363VFG0xKpweHeTIyJfoqxUTfn&currency=EUR"></script>
            ...
            $.get(__env+"api/lazyloading.codepromo?dfilters=on&code:eq="+code, function(data, status){
                ...
                if(data.listEntity.length > 0){
                    ...
                    if(data.listEntity[0].nbremonth == 0 || data.listEntity[0].state != 0){
                        //alert(data.listEntity[0].nbremonth);
                        //alert(data.listEntity[0].state);
                                            ...
                                            if(data.listEntity.length > 0){
                                                ...
                                                if(paypalplan == null){
                                                    $.ajax(settings).done(function (response) {
                                                        ...
                                                        $.get(__env+"api/lazyloading.codepromosubscription?dfilters=on&codepromo_id:eq="+codeid+"&subscription_id:eq={{$subscription->getId()}}", function(data, status){
                                                            console.log(data);
                                                            paypalplan = data.listEntity[0].paypalplan;
                                                            //alert(paypalplan);
                                                        ...
                                                        alert("{{tt('Une erreur est survenue durant l operation. Veuillez reésseyer')}}");
                                                    });
                                                }
                                                else{
                                                    //alert(paypalplan);
                                                ...
                                                var settings = {
                                                    "url": __env+"api/update.codepromo?id="+codeid,
                                                    "method": "PUT",
                                                    "timeout": 0,
                                                    "headers": {
