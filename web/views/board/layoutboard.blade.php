...
<head>
    ...
    <!-- Title -->
    <title>@yield("page_title", "LS2EC TRAINING - La cybersécurité démystifiée")</title>
...
<!-- Vendors Style-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ assets   }}vendor_components/signature/css/jquery.signature.css">
        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center">						
                    <h2 class="page-title text-white">@tt("My Account")</h2>
...
<script type="text/javascript" src="{{ assets   }}vendor_components/ckeditor/ckeditor.js"></script>
...
<script>
    ...
    $('.table').DataTable({
        "language": {
            "sProcessing": "@tt('Traitement en cours ...')",
            "sLengthMenu": "@tt('Afficher _MENU_ lignes')",
            "sZeroRecords": "@tt('Aucun résultat trouvé')",
            "sEmptyTable": "@tt('Aucune donnée disponible')",
            "sInfo": "@tt('Lignes _START_ à _END_ sur _TOTAL_')",
            "sInfoEmpty": "@tt('Aucune ligne affichée')",
            "sInfoFiltered": "@tt('(Filtrer un maximum de_MAX_)')",
            "sInfoPostFix": "",
            "sSearch": "@tt('Chercher:')",
            "sUrl": "",
            "sInfoThousands": ",",
            "sLoadingRecords": "@tt('Chargement...')",
            "oPaginate": {
            "sFirst": "@tt('Premier')", "sLast": "@tt('Dernier')", "sNext": "@tt('Suivant')", "sPrevious": "@tt('Précédent')"
            },
            "oAria": {
            "sSortAscending": "@tt(': Trier par ordre croissant')", "sSortDescending": "@tt(': Trier par ordre décroissant')"
            }
        },
        "order": []
    });
