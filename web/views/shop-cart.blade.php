...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/bs5/front-end/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jul 2021 12:37:20 GMT -->
<head>
    <meta charset="utf-8">
				  ...
				  <div class="box-body">
					<div class="table-responsive">
						<table class="table product-overview">
							...
							<tbody>
								<tr>
									<td><img src="../images/front-end-img/product/product-1.png" alt="" width="80"></td>
									<td>
								...
								<tr>
									<td><img src="../images/front-end-img/product/product-2.png" alt="" width="80"></td>
									<td>
										<h5>Product Name Here</h5>
										<p>Lorem Ipsum available the majority have suffered alteration in some.</p>
									</td>
								...
								<tr>
									<td><img src="../images/front-end-img/product/product-3.png" alt="" width="80"></td>
									<td>
										<h5>Product Name Here</h5>
										<p>Lorem Ipsum available the majority have suffered alteration in some.</p>
									</td>
								...
								<tr>
									<td><img src="../images/front-end-img/product/product-4.png" alt="" width="80"></td>
									<td>
										<h5>Product Name Here</h5>
										<p>Lorem Ipsum available the majority have suffered alteration in some.</p>
									</td>
								...
								<tr>
									<td><img src="../images/front-end-img/product/product-5.png" alt="" width="80"></td>
									<td>
										<h5>Product Name Here</h5>
										<p>Lorem Ipsum available the majority have suffered alteration in some.</p>
									</td>
								...
								<tr>
									<td><img src="../images/front-end-img/product/product-6.png" alt="" width="80"></td>
									<td>
										<h5>Product Name Here</h5>
										<p>Lorem Ipsum available the majority have suffered alteration in some.</p>
									</td>
