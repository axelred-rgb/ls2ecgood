...
"type" => FORMTYPE_TEXT,
        ...
        $this->fields['objectif'] = [
            "label" => t('courses.objectif'),
            "type" => FORMTYPE_TEXTAREA,
            "value" => $this->courses->getObjectif(),
        ];

        $this->fields['module'] = [
            "label" => t('courses.module'),
            "type" => FORMTYPE_TEXTAREA,
            "value" => $this->courses->getModule(),
        ];
...
"type" => FORMTYPE_TEXT,
        ...
        $this->fields['objectif_en'] = [
            "label" => t('courses.objectif_en'),
            "type" => FORMTYPE_TEXTAREA,
            "value" => $this->courses->getObjectif_en(),
        ];

        $this->fields['module_en'] = [
            "label" => t('courses.module_en'),
            "type" => FORMTYPE_TEXTAREA,
            "value" => $this->courses->getModule_en(),
        ];
