...
//
		...
		$paiementCtrl = new PaiementController();
     ...
     switch (R::get('path')) {
        ...
        case 'codepromo._new':
                g::json_encode($codepromoCtrl->formView());
                break;
        case 'codepromo.create':
                g::json_encode($codepromoCtrl->createAction());
                break;
        case 'codepromo._edit':
                g::json_encode($codepromoCtrl->formView(R::get("id")));
                break;
        case 'codepromo.update':
                g::json_encode($codepromoCtrl->updateAction(R::get("id")));
                break;
        case 'codepromo._show':
                $codepromoCtrl->detailView(R::get("id"));
                break;
        case 'codepromo._delete':
                g::json_encode($codepromoCtrl->deleteAction(R::get("id")));
                break;
        case 'codepromo._deletegroup':
                g::json_encode($codepromoCtrl->deletegroupAction(R::get("ids")));
                break;
        case 'codepromo.datatable':
                g::json_encode($codepromoCtrl->datatable(R::get('next'), R::get('per_page')));
                break;
        ...
        case 'exercise._new':
                g::json_encode($exerciseCtrl->formView());
                break;
        case 'exercise.create':
                g::json_encode($exerciseCtrl->createAction());
                break;
        case 'exercise._edit':
                g::json_encode($exerciseCtrl->formView(R::get("id")));
                break;
        case 'exercise.update':
                g::json_encode($exerciseCtrl->updateAction(R::get("id")));
                break;
        case 'exercise._show':
                $exerciseCtrl->detailView(R::get("id"));
                break;
        case 'exercise._delete':
                g::json_encode($exerciseCtrl->deleteAction(R::get("id")));
                break;
        case 'exercise._deletegroup':
                g::json_encode($exerciseCtrl->deletegroupAction(R::get("ids")));
                break;
        case 'exercise.datatable':
                g::json_encode($exerciseCtrl->datatable(R::get('next'), R::get('per_page')));
                break;
        ...
        case 'paiement._new':
                g::json_encode($paiementCtrl->formView());
                break;
        case 'paiement.create':
                g::json_encode($paiementCtrl->createAction());
                break;
        case 'paiement._edit':
                g::json_encode($paiementCtrl->formView(R::get("id")));
                break;
        case 'paiement.update':
                g::json_encode($paiementCtrl->updateAction(R::get("id")));
                break;
        case 'paiement._show':
                $paiementCtrl->detailView(R::get("id"));
                break;
        case 'paiement._delete':
                g::json_encode($paiementCtrl->deleteAction(R::get("id")));
                break;
        case 'paiement._deletegroup':
                g::json_encode($paiementCtrl->deletegroupAction(R::get("ids")));
                break;
        case 'paiement.datatable':
                g::json_encode($paiementCtrl->datatable(R::get('next'), R::get('per_page')));
                break;
        ...
        case 'subscription_courses._new':
                g::json_encode($subscription_coursesCtrl->formView());
                break;
        case 'subscription_courses.create':
                g::json_encode($subscription_coursesCtrl->createAction());
                break;
        case 'subscription_courses._edit':
                g::json_encode($subscription_coursesCtrl->formView(R::get("id")));
                break;
        case 'subscription_courses.update':
                g::json_encode($subscription_coursesCtrl->updateAction(R::get("id")));
                break;
        case 'subscription_courses._show':
                $subscription_coursesCtrl->detailView(R::get("id"));
                break;
        case 'subscription_courses._delete':
                g::json_encode($subscription_coursesCtrl->deleteAction(R::get("id")));
                break;
        case 'subscription_courses._deletegroup':
                g::json_encode($subscription_coursesCtrl->deletegroupAction(R::get("ids")));
                break;
        case 'subscription_courses.datatable':
                g::json_encode($subscription_coursesCtrl->datatable(R::get('next'), R::get('per_page')));
                break;
