<?php 
    ...
    class Courses extends Model implements JsonSerializable{
        ...
        **/
        protected $objectif;
        /**
         * @Column(name="objectif_en", type="text"  )
         * @var text
         **/
        protected $objectif_en;
         /**
        ...
        protected $module;
        /**
         * @Column(name="module_en", type="text"  )
         * @var text
         **/
        protected $module_en;
        /**
        ...
        /**
         * @Column(name="providerfreecoursesid", type="integer"  , nullable=true)
         * @var integer
         **/
        protected $providerfreecoursesid;
        ...
        * @var integer
        ...
        /**
         * @Column(name="duree", type="string"  , nullable=true)
         * @var string
         **/
        protected $duree;
	...
	$this->provider = new Provider();
        ...
        public function getObjectif_en() {
            return $this->objectif_en;
        }

        public function setObjectif_en($objectif_en) {
            $this->objectif_en = $objectif_en;
        }
        ...
        public function getProviderfreecoursesid() {
            return $this->providerfreecoursesid;
        }

        public function setProviderfreecoursesid($providercoursesid) {
            $this->providerfreecoursesid = $providercoursesid;
        }
        ...
        public function getModule_en() {
            return $this->module_en;
        }

        public function setModule_en($module_en) {
        ...
        public function jsonSerialize() {
                return [
                    ...
                    'module' => $this->module,
                    'module_en' => $this->module_en,
                    'objectif' => $this->objectif,
                    'objectif_en' => $this->objectif_en,
                    'type' => $this->type,
                    'duree' => $this->duree,
                    'providerfreecoursesid'=>$this->providerfreecoursesid
                ];
        }
