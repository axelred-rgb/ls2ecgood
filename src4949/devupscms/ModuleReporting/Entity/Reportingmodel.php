...
// Output a PDF file directly to the browser
    ...
    {
        return utf8_encode($this->object);
    }
...
// Instantiation and passing `true` enables exceptions
        ...
        try {
            ...
            //Recipients
            $mail->setFrom(Configuration::get("sm_from"),  utf8_encode($this->title));
            $mail->addAddress(self::$emailreceiver[0], self::$namereceiver[0]);     // Add a recipient
            //$mail->addAddress('ellen@example.com');               // Name is optional
            $mail->addReplyTo(Configuration::get("sm_from"),  utf8_encode($this->title));
...
//            $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
            ...
            $mail->Subject = utf8_encode($this->object);
            ...
            $result = $mail->send();
            Emaillog::create([
                "object" => self::$log_info . " - object : " . utf8_encode($this->object) . ' to ' . self::$emailreceiver[0],
